...
- **Генерация новых тем**: Кнопка "Больше тем" позволяет получить свежий список уникальных тем
...
- **Скрытие правильных ответов** во время прохождения теста для честной самооценки
...
- **Очистка истории чата**: После каждого действия пользователя чат очищается для лучшего восприятия
...
- **Честная проверка знаний**: Правильные ответы не показываются во время прохождения теста
...
- **Чистый интерфейс**: Удаление предыдущих сообщений для поддержания фокуса на текущей беседе
...
- **Очистка истории чата**: Автоматическое удаление предыдущих сообщений для защиты конфиденциальности
...
- **Очистка чата**: Автоматическое удаление старых сообщений для сохранения чистоты интерфейса
...
- **Изоляция контекста**: Раздельное хранение данных для каждого пользователя
