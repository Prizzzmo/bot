...
Образовательный бот по истории России — это интерактивная образовательная платформа, реализованная в виде Telegram-бота. Проект предоставляет удобный и структурированный доступ к историческим знаниям, тестам и интерактивным обучающим материалам.

Бот разработан с использованием модульной архитектуры, что обеспечивает высокую расширяемость, поддерживаемость и производительность.
...
- **Google Gemini Pro**: AI-модель для генерации контента и обработки запросов
- **Flask**: Веб-фреймворк для административного интерфейса

### Подходы и паттерны:
- **Модульная архитектура**: Разделение ответственности между компонентами
- **Интерфейсы и абстракции**: Использование абстрактных классов для гибкости
- **Фабричный метод**: Централизованное создание компонентов системы
