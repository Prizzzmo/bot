    ...
    def button_handler(self, update, context):
        ...
        if query_data == 'back_to_menu':
            ...
            try:
                ...
                # Отправляем расширенный реферат по проектной деятельности
                if os.path.exists('Реферат_Проектная_деятельность_расширенный.docx'):
                    with open('Реферат_Проектная_деятельность_расширенный.docx', 'rb') as ref_docx:
                        sent_ref_docx = context.bot.send_document(
                            chat_id=update.effective_chat.id,
                            document=ref_docx,
                            filename='Реферат_Проектная_деятельность_расширенный.docx',
                            caption="📄 Расширенный реферат по проектной деятельности"
                        )
                ...
                try:
                    ...
                    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
                        ...
                        # Добавляем расширенный реферат по проектной деятельности если он существует
                        if os.path.exists('Реферат_Проектная_деятельность_расширенный.docx'):
                            zip_file.write('Реферат_Проектная_деятельность_расширенный.docx')
