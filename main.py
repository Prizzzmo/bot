    ...
    if query.data == 'custom_topic':
        ...
        try:
            ...
            if 0 <= topic_index < len(context.user_data['topics']):
                ...
                # Разделяем длинный текст на части, чтобы избежать ограничений Telegram
                if len(response) > 4000:  # Максимальная длина сообщения в Telegram
                    ...
                    # Отображаем весь текст целиком, если он короткий
