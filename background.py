...
def chat():
    try:
        ...
        prompt = f"Пользователь задал вопрос или начал беседу на тему истории России: \"{user_message}\"\n\nОтветь на этот вопрос или продолжи беседу, опираясь на исторические факты. Будь информативным, но кратким. Если вопрос не относится к истории России, вежливо направь беседу в историческое русло."
